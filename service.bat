...
set "GITHUB_VERSION_URL=https://raw.githubusercontent.com/yuzuki23/zaprerik-/master/.service/version.txt"
...
set "hostsUrl=https://raw.githubusercontent.com/yuzuki23/zaprerik-/master/zapret-hosts.txt"
